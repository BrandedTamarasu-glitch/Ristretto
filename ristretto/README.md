# Ristretto — Unraid Dark Theme

A dark Unraid theme inspired by dark roast coffee. Deep brown canvas, pale crema accents, warm ivory text. Designed for long sessions — rich and warm without the eye strain of cold black-and-white interfaces. Companion to [Crema](../crema) (light).

**Base theme:** Dynamix Black
...
Copy `ground-control-banner.png` to:
```
